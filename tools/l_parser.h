	...
	*/
	...
	class LSystem
	{
		...
		public:
			...
			/**
			 * \brief Replacement function. Returns the rules string for a given character of the Alphabet
			 *
			 * \param c 	the character of the alphabet
			 *
			 * \return	rules string
			...
			/**
			 * \brief Retrurns the number of times a symbol must be replaced by it's rules string
			 *
		...
		protected:
			...
			double angle;
		        ...
		        /**
		         * \brief the rules rules of the l-system
		         */
