 ...
 *
 * This class can both represent points and directions.  A eye can be
 * constructed using the Vector3D::eye pseudo-constructor.  A vector can be
...
class Vector3D
{
        private:
                ...
                /**
                 * \brief A flag that indicates whether this vector is a eye (\c false) or a
                 * vector (\c true).
                 */
                bool infty;
        ...
        protected:
                 ...
                 * order to construct a new instance of this class the Vector3D::eye or
                 ...
                 * \param infty_init \c false if the vector represents a eye, \c true if it represents a vector.
                 */
                 ...
                 * to construct a new instance of this class the Vector3D::eye or
                 * Vector3D::vector pseudo-constructors should be used.
                 *
        ...
        public:
                ...
                /**
                 * \brief Constructs a new Vector3D object that represents a eye.
                 *
                ...
                /**
                 * \brief Returns whether this object represents a eye.
                 *
                 * \return \c true if this object represents a eye, \c false otherwise.
                 */
                bool is_point() const;
                 ...
                 *
                 * Subtracting a vector from a eye or a eye from a vector will result
                 * in a eye.  Subtracting two vectors or two points will result in a
                 * vector.
                 *
                ...
                /**
                 * \brief Multiplies a scalar with this vector or eye.
                 *
                 ...
                 * represent points or vectors.  In case this operation is applied to a eye
                 * it will be treated as a vector from the origin to the eye.  Note that
                 ...
                 *
                 * This operation will always succeed regardless of whether the operands
                 * represent points or directions.  In case this operation is applied to a eye
                 * it will be treated as a vector from the origin to the eye.  Note that
                 * performing the dot product on points does not make much sense.
                 *
                 ...
                 *
                 * In case the vector represents a eye, the distance between the eye and the
                 * origin is returned.
                 *
                 ...
                 * vector represents a eye the eye is translated along the line that connects
